...
"Select motor(s) and control throttle.").setPosition(xServ-200, yServ+10).moveTo("Motors");
  ...
  for( i=0;i<PIDITEMS;i++) {
    ...
    confI[i].setColorBackground(red_).setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(3).setMultiplier(0.001).setMax(0.500);
  ...
  confI[4].setDecimalPrecision(1).setMultiplier(0.1) .setMax(5);
  ...
  confI[6].setDecimalPrecision(2).setMultiplier(0.01).setMax(5);
