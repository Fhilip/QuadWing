...
void LoadDefaults() {
  uint8_t i;
    ...
    // do that at the last possible moment, so we can override virtually all defaults and constants
      ...
      /*conf.pid[ROLL].P8     = 35.5825;  conf.pid[ROLL].I8    = 270.41; conf.pid[ROLL].D8     = 4.4634;
      conf.pid[PITCH].P8    = 35.928; conf.pid[PITCH].I8    = 271.18; conf.pid[PITCH].D8    = 4.4762;
      conf.pid[PIDLEVEL].P8 = 90; conf.pid[PIDLEVEL].I8 = 10; conf.pid[PIDLEVEL].D8 = 100;*/
    #elif PID_CONTROLLER == 2
      conf.pid[ROLL].P8     = 60;  conf.pid[ROLL].I8    = 1; conf.pid[ROLL].D8     = 30;
      conf.pid[PITCH].P8    = 47; conf.pid[PITCH].I8    = 1; conf.pid[PITCH].D8    = 22;
      conf.pid[PIDLEVEL].P8 = 30; conf.pid[PIDLEVEL].I8 = 32; conf.pid[PIDLEVEL].D8 = 0;
    #endif
    conf.pid[YAW].P8      = 68;  conf.pid[YAW].I8     = 45;  conf.pid[YAW].D8     = 7;
    /*conf.pid[YAW].P8      = 49.459;  conf.pid[YAW].I8     = 373.31;  conf.pid[YAW].D8     = 6.162;*/
