...
// #define COPTERTEST 20 // Patrik Test setup
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    independent sensors    ********************************/
      ...
      #define FORCE_ACC_ORIENTATION(X, Y, Z)  {imu.accADC[ROLL]  =  Z; imu.accADC[PITCH]  = -X; imu.accADC[YAW]  = -Y;}
      #define FORCE_GYRO_ORIENTATION(X, Y, Z) {imu.gyroADC[ROLL] = -Z; imu.gyroADC[PITCH] = -X; imu.gyroADC[YAW] = -Y;}
      #define FORCE_MAG_ORIENTATION(X, Y, Z)  {imu.magADC[ROLL]  = -Z; imu.magADC[PITCH]  = X; imu.magADC[YAW]  = Y;}
...
/*************************************************************************************************/
  ...
  /***********************          Flying Wing                    ***********************/
	...
	#define ROLLRATE  1.5f
	#define PITCHRATE 1.5f
  ...
  /***********************      your individual defaults     ***********************/
     ...
     */
    //#define MY_PRIVATE_DEFAULTS "Pdefaults.h"
