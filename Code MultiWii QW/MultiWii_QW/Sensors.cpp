...
//default board orientation
  ...
  #define ACC_ORIENTATION(X, Y, Z)  {imu.accADC[ROLL]  = -Z; imu.accADC[PITCH]  = Y; imu.accADC[YAW]  = X;} //default X, Y, Z
#endif
#if !defined(GYRO_ORIENTATION) 
  #define GYRO_ORIENTATION(X, Y, Z) {imu.gyroADC[ROLL] = -Z; imu.gyroADC[PITCH] = Y; imu.gyroADC[YAW] = X;} //default X, Y, Z
#endif
#if !defined(MAG_ORIENTATION) 
  #define MAG_ORIENTATION(X, Y, Z)  {imu.magADC[ROLL]  = -Z; imu.magADC[PITCH]  = Y; imu.magADC[YAW]  = X;} //default X, Y, Z
#endif
