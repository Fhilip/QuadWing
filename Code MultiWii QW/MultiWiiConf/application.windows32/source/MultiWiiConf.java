...
"Select motor(s) and control throttle.").setPosition(xServ-200, yServ+10).moveTo("Motors");
  ...
  for( i=0;i<PIDITEMS;i++) {
    ...
    confI[i].setColorBackground(red_).setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(3).setMultiplier(0.001f).setMax(0.500f);
  ...
  confI[4].setDecimalPrecision(1).setMultiplier(0.1f) .setMax(5);
  ...
  confI[6].setDecimalPrecision(2).setMultiplier(0.01f).setMax(5);
